...
class GetFreeProxy(object):
    ...
    def freeProxySecond(count=20):
        ...
        """
        urls = [
            "http://www.66ip.cn/mo.php?sxb=%CF%E3%B8%DB&tqsl={count}&port=&export=&ktip=&sxa=&submit=%CC%E1++%C8%A1&textarea=",
            "http://www.66ip.cn/nmtq.php?getnum={count}"
            "&isp=0&anonymoustype=0&start=&ports=&export=&ipaddress=&area=2&proxytype=2&api=66ip",
            ]
        request = WebRequest()
        for _ in urls:
    ...
    def freeProxyFourth(page_count=1):
        """
        西刺代理 http://www.xicidaili.com 只有国内代理
        :return:
        """
        url_list = [
    ...
    def freeProxyFifth():
        """
        guobanjia http://www.goubanjia.com/ 免费国外代理太少
        :return:
        """
    ...
    def freeProxySeventh():
        """
        快代理 https://www.kuaidaili.com 免费没有国外代理
        """
        url_list = [
    ...
    def freeProxyTen():
        ...
        :return:
        """
        urls = ['http://www.ip3366.net/free/?stype=3','http://www.ip3366.net/free/?stype=4']
        request = WebRequest()
        for url in urls:
            r = request.get(url, timeout=10)
